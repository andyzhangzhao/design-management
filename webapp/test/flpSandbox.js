						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#projectmanagement-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"projectmanagement-display": {
								"semanticObject": "projectmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectmanagement",
									"url": sap.ui.require.toUrl("projectmanagement")
								}
							}
						}
					}
