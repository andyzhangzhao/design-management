sap.ui.define(
    ...
    function (Controller, JSONModel, Filter) {
        ...
        return Controller.extend("projectmanagement.controller.MaterialManagement", {
            onInit: function () {
            ...
            tableUpdateFinished: function (oEvent) {
                this.oView.getModel("ui").setProperty("/materialManagementCount", oEvent.getParameter("total"));
            },
        });
    }
);