sap.ui.define(
    ...
    function (Controller, JSONModel, Filter) {
        ...
        return Controller.extend("projectmanagement.controller.DesignResultManagement", {
            onInit: function () {
                this.designResultManagementTable = this.byId('designResultManagementTable')
            ...
            tableUpdateFinished: function (oEvent) {
                this.oView.getModel("ui").setProperty("/designResultManagementCount", oEvent.getParameter("total"));
            },
        });
    }
);