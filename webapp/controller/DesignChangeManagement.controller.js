sap.ui.define(
    ...
    function (Controller, JSONModel, Filter) {
        ...
        return Controller.extend("projectmanagement.controller.DesignChangeManagement", {
            onInit: function () {
                this.designChangeManagementTable = this.byId('designChangeManagementTable')
            ...
            _onObjectMatched: function (oEvent) {
                ...
                if (this.section === 'I') {
                    var listBinding = this.designChangeManagementTable.getBinding('items')
            ...
            tableUpdateFinished: function (oEvent) {
                this.oView.getModel("ui").setProperty("/designChangeManagementCount", oEvent.getParameter("total"));
            },
        });
    }
);